...
class ExplorationAssets: 
	...
	# 达摩怪 
	I_UP_DARUMA = RuleImage(roi_front=(1146,510,80,80), roi_back=(0,353,1280,285), threshold=0.8, method="Sift Flann", file="./tasks/Exploration/highlight/highlight_up_daruma.png")
