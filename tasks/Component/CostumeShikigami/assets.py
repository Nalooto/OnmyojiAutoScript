...
class CostumeShikigamiAssets: 
	...
	# 第一组切换 
	I_SOU_SWITCH_1_9 = RuleImage(roi_front=(976,140,25,27), roi_back=(960,131,60,50), threshold=0.8, method="Template matching", file="./tasks/Component/CostumeShikigami/sk9/sk9_sou_switch_1_9.png")
	# 第二组切换 
	I_SOU_SWITCH_2_9 = RuleImage(roi_front=(976,295,25,27), roi_back=(960,285,60,50), threshold=0.8, method="Template matching", file="./tasks/Component/CostumeShikigami/sk9/sk9_sou_switch_2_9.png")
	# 第三组切换 
	I_SOU_SWITCH_3_9 = RuleImage(roi_front=(976,449,25,27), roi_back=(960,442,60,50), threshold=0.8, method="Template matching", file="./tasks/Component/CostumeShikigami/sk9/sk9_sou_switch_3_9.png")
	# 第四组切换 
	I_SOU_SWITCH_4_9 = RuleImage(roi_front=(976,602,25,27), roi_back=(960,592,60,50), threshold=0.8, method="Template matching", file="./tasks/Component/CostumeShikigami/sk9/sk9_sou_switch_4_9.png")
	# 确认切换 
	...
	# 需要切换的预设按钮(颜色深一点) 
	I_SOU_CLICK_PRESENT_9 = RuleImage(roi_front=(975,296,25,27), roi_back=(965,132,49,500), threshold=0.8, method="Template matching", file="./tasks/Component/CostumeShikigami/sk9/sk9_sou_click_present_9.png")
	# 选中的御魂 
