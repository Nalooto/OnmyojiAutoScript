...
class SwitchSoulAssets: 
	...
	# 取消下载式神音频 
	I_CLOSE_DOWNLOAD = RuleImage(roi_front=(413,478,144,64), roi_back=(413,478,144,64), threshold=0.8, method="Template matching", file="./tasks/Component/SwitchSoul/ss/ss_close_download.png")
